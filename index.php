...
<body>
        ...
        <h5>" 2020 ပြည့်နှစ် စက်တင်ဘာလ 1 ရက်/10 ကြိမ်မြောက်ထီပေါက်စဉ် " </h5>
          ...
          <!-- form start -->
                    ...
                    <div class="row justify-content-center mt-2 ">   
                            <div class="form-group-lg">
                                <div class="form-control-lg  ">
                                    ...
                                    <input type="number"maxlength="6"min="1"name="number"required placeholder="ထီနံပတ်ထည့်ပါ...">
                    </div>
            ...
            <!-- button strt -->
                    <div class="row justify-content-center mt-4 ">
                        <a href="indexx.php"class="btn btn-dark button">အက္ခရာအလိုက်စဉ်မယ်&nbsp;<i class="far fa-arrow-alt-circle-right"></i></a>  
  ...
  <!-- prize show start          -->
          <div class="row justify-content-center">
             ...
             <div class="mt-2 hu">သိန်းတစ်သောင်းခွဲဆုကြီး</div>
                        <?php foreach($finalresult as $finalresults): ?>
                            <?php if($finalresults->number_id==1):?>
                                      <div class="  show-num ">           
                                        <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>
                                      </div>
                          <?php endif; ?>
                       <?php endforeach; ?>
             </div>   
          ...
          <div class="row justify-content-center">
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သိန်းတစ်သောင်းဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==2):?> 
                                      <div class=" show-num">
                                          <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>     
                                      </div>
                        <?php endif; ?>
                  ...
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သိန်းငါထောင်ဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==3):?>
          ...
          <div class="row justify-content-center">
                  <div class="col-md-6 col-xs-12">
                    <div class="mt-2 hu">သိန်းနှစ်ထောင်ဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==4):?> 
                                      <div class=" show-num">
                                          <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>     
                                      </div>
                        <?php endif; ?>
                  ...
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သိန်းတစ်ထောင်ဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==5):?>
          ...
          <div class="row justify-content-center">
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သိန်းငါးရာဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==6):?> 
                                      <div class=" show-num">
                                          <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>     
                                      </div>
                        <?php endif; ?>
                  ...
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သိန်းနှစ်ရာဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==7):?>       
                                    <div class=" show-num ">            
                                      <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>
                                    </div>
                        <?php endif; ?>
          ...
          <div class="row justify-content-center">
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သိန်းတစ်ရာဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==8):?> 
                                      <div class=" show-num">
                                          <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>     
                                      </div>
                        <?php endif; ?>
                  ...
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သိန်းငါးဆယ်ဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==9):?>
          ...
          <div class="row justify-content-center">
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သိန်းနှစ်ဆယ်ဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==10):?> 
                                      <div class=" show-num">
                                          <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>     
                                      </div>
                        <?php endif; ?>
                  ...
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">ဆယ်သိန်းဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==11):?>                    
                                    <div class=" show-num ">            
                                      <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>
                                    </div>
                        <?php endif; ?>
          ...
          <div class="row justify-content-center">
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">သုံးသိန်းဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==12):?> 
                                      <div class=" show-num">
                                          <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>     
                                      </div>
                        <?php endif; ?>
                  ...
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">နှစ်သိန်းဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==13):?>       
                                    <div class=" show-num ">            
                                      <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>
                                    </div>
                        <?php endif; ?>
          ...
          <div class="row justify-content-center">
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">တစ်သိန်းဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==14):?> 
                                      <div class=" show-num">
                                          <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>     
                                      </div>
                        <?php endif; ?>
                  ...
                  <div class="col-md-6 col-xs-12">
                   <div class="mt-2 hu">ငါသောင်းဆုကြီး</div>
                      <?php foreach($finalresult as $finalresults): ?>
                          <?php if($finalresults->number_id==15):?>                     
                                    <div class=" show-num ">            
                                      <div > <?php echo $finalresults->letter." ".$finalresults->number?></div>
                                    </div>  
                        <?php endif; ?>
